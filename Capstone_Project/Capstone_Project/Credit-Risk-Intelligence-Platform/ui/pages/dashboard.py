...
def _kpi_row(state: PlatformState) -> None:
    ...
    with c5:
        if ra:
            # Same precise-match fix as risk_analysis.py — "Conditionally
            # Eligible" must show amber (cautionary), not bright green.
            elig_lower = ra.loan_eligibility.strip().lower()
